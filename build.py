...
parser.add_argument('--with-sbx', action='store_true', help='Build the SBX extension')
...
extra_flags = [f'-DGODOT_POCKETPY_WITH_SBX={"ON" if args.with_sbx else "OFF"}']
...
run(['cmake', '-B', 'build', f'-DCMAKE_BUILD_TYPE={config}', *extra_flags])
