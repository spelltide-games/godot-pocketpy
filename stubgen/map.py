...
class _DummyExtendsScript[T: PythonScriptInstance]:
    def __call__(self, path: str) -> type[T]: ...

class _DummyExtends:
    def __getitem__[T: PythonScriptInstance](self, cls: type[T]) -> _DummyExtendsScript[T]: ...
    def __call__[T: classes.Object](self, cls: type[T]) -> type[PythonScriptInstance[T]]: ...

Extends = _DummyExtends()
